...
class LayerNormParser(Parser):
    ...
    def generate_layer_node_for_layernorm(self):
        def get_layer_node_input_format(B, C, node_mapping, nodes_outputs):
            ...
            # Equation
            d = {}
            d["equation"] = "O[b][c]+=I[b][c] * scale[c]"
            ...
            d["operand_precision"] = {"O": 16, "I": 8, "scale": 8}
            d["operand_source"] = {"I": [], "scale": []}
            d["constant_operands"] = ["scale"]
            ...
            d["memory_operand_links"] = {"O": "O", "I": "I1", "scale": "I2"}
