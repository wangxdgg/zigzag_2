...
model_path = 'zigzag.inputs.examples.workload.resnet18'
mapping_path = 'zigzag.inputs.examples.mapping.default'
accelerator_path = 'zigzag.inputs.examples.hardware.Eyeriss_like'

parser.add_argument('--model', required=True, help='module path to workload, e.g. inputs.examples.workloads.resnet18')
parser.add_argument('--mapping', required=True, help='path to mapping file, e.g., inputs.examples.mapping.tpu_like')
parser.add_argument('--accelerator', required=True, help='module path to the accelerator, e.g. inputs.examples.hardware.TPU_like')

args = parser.parse_args(['--model', model_path, '--mapping', mapping_path, '--accelerator', accelerator_path])
